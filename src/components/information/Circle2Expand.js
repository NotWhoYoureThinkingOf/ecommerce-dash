...
const Circle2Expand = ({ layoutId, onClick, layoutImg }) => {
  return (
    <motion.div
      className="circle2Expand"
      initial={{ clipPath: "circle(0% at 50% 46%)" }}
      animate={{ clipPath: "circle(120% at 50% 46%)" }}
      style={{
